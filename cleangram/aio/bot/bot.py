...
class Bot(BaseBot):
    ...
    async def __call__(
        ...
        return await self.config.http(self, path, http_timeout)
    ...
    async def get_updates(
        ...
        :param offset: Identifier of the first update to be returned. Must
            be greater by one than the highest among the identifiers of
        ...
        :param timeout: Timeout in seconds for long polling. Defaults to
            0, i.e. usual short polling. Should be positive, short polling
            should be used for testing purposes only.
        :param allowed_updates: A JSON-serialized list of the update types
            you want your bot to receive. For example, specify [“message”,
            “edited_channel_post”, “callback_query”] to only receive updates
            of these types. See Update for a complete list of available
            update types. Specify an empty list to receive all update types
            except chat_member (default). If not specified, the previous
    ...
    async def set_webhook(
        ...
        :param certificate: Upload your public key certificate so that the
            root certificate in use can be checked. See our self-signed guide
            for details.
        :param ip_address: The fixed IP address which will be used to send
            webhook requests instead of the IP address resolved through DNS
        :param max_connections: The maximum allowed number of simultaneous
        ...
        :param allowed_updates: A JSON-serialized list of the update types
            ...
            setting will be used.Please note that this parameter doesn't
            affect updates created before the call to the setWebhook, so
            unwanted updates may be received for a short period of time.
    ...
    async def get_webhook_info(
        self, http_timeout: Optional[float] = None
    ) -> WebhookInfo:
        """
        ...
        """
        return await self(GetWebhookInfo(), http_timeout=http_timeout)

    # Available methods

    async def get_me(self, http_timeout: Optional[float] = None) -> User:
        """
        ...
        """
        return await self(GetMe(), http_timeout=http_timeout)

    async def log_out(self, http_timeout: Optional[float] = None) -> bool:
        """
        ...
        """
        return await self(LogOut(), http_timeout=http_timeout)

    async def close(self, http_timeout: Optional[float] = None) -> bool:
        """
        ...
        """
        return await self(Close(), http_timeout=http_timeout)
    ...
    async def send_message(
        ...
        :param entities: A JSON-serialized list of special entities that
            appear in message text, which can be specified instead of
            parse_mode
        ...
        :param allow_sending_without_reply: Pass True, if the message
            should be sent even if the specified replied-to message is not
            found
        :param reply_markup: Additional interface options. A JSON-
            serialized object for an inline keyboard, custom reply keyboard,
    ...
    async def copy_message(
        ...
        :param message_id: Message identifier in the chat specified in
            from_chat_id
        :param caption: New caption for media, 0-1024 characters after
        ...
        :param caption_entities: A JSON-serialized list of special
            entities that appear in the new caption, which can be specified
    ...
    async def send_photo(
        ...
        :param chat_id: Unique identifier for the target chat or username
            of the target channel (in the format @channelusername)
        :param photo: Photo to send. Pass a file_id as String to send a
            photo that exists on the Telegram servers (recommended), pass an
            HTTP URL as a String for Telegram to get a photo from the
            Internet, or upload a new photo using multipart/form-data. The
            photo must be at most 10 MB in size. The photo's width and height
            must not exceed 10000 in total. Width and height ratio must be at
            most 20. More information on Sending Files »
        :param caption: Photo caption (may also be used when resending
    ...
    async def send_audio(
        ...
        :param chat_id: Unique identifier for the target chat or username
            of the target channel (in the format @channelusername)
        :param audio: Audio file to send. Pass a file_id as String to send
            an audio file that exists on the Telegram servers (recommended),
        ...
        :param caption: Audio caption, 0-1024 characters after entities
            parsing
        ...
        :param thumb: Thumbnail of the file sent; can be ignored if
            ...
            A thumbnail's width and height should not exceed 320. Ignored if
    ...
    async def send_document(
        ...
        :param caption_entities: A JSON-serialized list of special
            entities that appear in the caption, which can be specified
            instead of parse_mode
        :param disable_content_type_detection: Disables automatic server-
            side content type detection for files uploaded using
            multipart/form-data
        :param disable_notification: Sends the message silently. Users
            will receive a notification with no sound.
        :param protect_content: Protects the contents of the sent message
    ...
    async def send_video(
        ...
        :param chat_id: Unique identifier for the target chat or username
            of the target channel (in the format @channelusername)
        :param video: Video to send. Pass a file_id as String to send a
            video that exists on the Telegram servers (recommended), pass an
            HTTP URL as a String for Telegram to get a video from the
            Internet, or upload a new video using multipart/form-data. More
            information on Sending Files »
        ...
        :param thumb: Thumbnail of the file sent; can be ignored if
            ...
            uploaded using multipart/form-data under <file_attach_name>. More
            information on Sending Files »
        :param caption: Video caption (may also be used when resending
        ...
        :param caption_entities: A JSON-serialized list of special
            entities that appear in the caption, which can be specified
            instead of parse_mode
        :param supports_streaming: Pass True, if the uploaded video is
    ...
    async def send_animation(
        ...
        :param chat_id: Unique identifier for the target chat or username
            of the target channel (in the format @channelusername)
        :param animation: Animation to send. Pass a file_id as String to
            send an animation that exists on the Telegram servers
            (recommended), pass an HTTP URL as a String for Telegram to get
            an animation from the Internet, or upload a new animation using
        ...
        :param parse_mode: Mode for parsing entities in the animation
            caption. See formatting options for more details.
        :param caption_entities: A JSON-serialized list of special
            entities that appear in the caption, which can be specified
            instead of parse_mode
    ...
    async def send_voice(
        ...
        :param chat_id: Unique identifier for the target chat or username
            of the target channel (in the format @channelusername)
        :param voice: Audio file to send. Pass a file_id as String to send
            a file that exists on the Telegram servers (recommended), pass an
            HTTP URL as a String for Telegram to get a file from the
            Internet, or upload a new one using multipart/form-data. More
            information on Sending Files »
        :param caption: Voice message caption, 0-1024 characters after
            entities parsing
        :param parse_mode: Mode for parsing entities in the voice message
            caption. See formatting options for more details.
        :param caption_entities: A JSON-serialized list of special
            entities that appear in the caption, which can be specified
            instead of parse_mode
    ...
    async def send_video_note(
        ...
        :param video_note: Video note to send. Pass a file_id as String to
            send a video note that exists on the Telegram servers
            (recommended) or upload a new video using multipart/form-data.
            More information on Sending Files ». Sending video notes by a URL
            is currently unsupported
        :param duration: Duration of sent video in seconds
        :param length: Video width and height, i.e. diameter of the video
            message
        :param thumb: Thumbnail of the file sent; can be ignored if
            thumbnail generation for the file is supported server-side. The
            thumbnail should be in JPEG format and less than 200 kB in size.
    ...
    async def send_media_group(
        ...
        :param chat_id: Unique identifier for the target chat or username
            of the target channel (in the format @channelusername)
        :param media: A JSON-serialized array describing messages to be
            sent, must include 2-10 items
        :param disable_notification: Sends messages silently. Users will
            receive a notification with no sound.
        :param protect_content: Protects the contents of the sent messages
            from forwarding and saving
        :param reply_to_message_id: If the messages are a reply, ID of the
            original message
        :param allow_sending_without_reply: Pass True, if the message
            should be sent even if the specified replied-to message is not
            found
    ...
    async def send_location(
        ...
        :param horizontal_accuracy: The radius of uncertainty for the
            location, measured in meters; 0-1500
        :param live_period: Period in seconds for which the location will
            be updated (see Live Locations, should be between 60 and 86400.
        :param heading: For live locations, a direction in which the user
    ...
    async def edit_message_live_location(
        ...
        :param horizontal_accuracy: The radius of uncertainty for the
            location, measured in meters; 0-1500
        :param heading: Direction in which the user is moving, in degrees.
            Must be between 1 and 360 if specified.
        :param proximity_alert_radius: The maximum distance for proximity
    ...
    async def send_venue(
        ...
        :param google_place_type: Google Places type of the venue. (See
            supported types.)
        :param disable_notification: Sends the message silently. Users
            will receive a notification with no sound.
        :param protect_content: Protects the contents of the sent message
    ...
    async def send_poll(
        ...
        :param options: A JSON-serialized list of answer options, 2-10
            strings 1-100 characters each
        :param is_anonymous: True, if the poll needs to be anonymous,
            defaults to True
        :param type: Poll type, “quiz” or “regular”, defaults to “regular”
        :param allows_multiple_answers: True, if the poll allows multiple
        ...
        :param explanation: Text that is shown when a user chooses an
            incorrect answer or taps on the lamp icon in a quiz-style poll,
            0-200 characters with at most 2 line feeds after entities parsing
        :param explanation_parse_mode: Mode for parsing entities in the
            explanation. See formatting options for more details.
        :param explanation_entities: A JSON-serialized list of special
            entities that appear in the poll explanation, which can be
            specified instead of parse_mode
        :param open_period: Amount of time in seconds the poll will be
            active after creation, 5-600. Can't be used together with
            close_date.
        :param close_date: Point in time (Unix timestamp) when the poll
            will be automatically closed. Must be at least 5 and no more than
            600 seconds in the future. Can't be used together with
            open_period.
        :param is_closed: Pass True, if the poll needs to be immediately
    ...
    async def send_dice(
        ...
        :param emoji: Emoji on which the dice throw animation is based.
            ...
            have values 1-6 for “”, “” and “”, values 1-5 for “” and “”, and
    ...
    async def send_chat_action(
        ...
        :param chat_id: Unique identifier for the target chat or username
            of the target channel (in the format @channelusername)
        :param action: Type of action to broadcast. Choose one, depending
            on what the user is about to receive: typing for text messages,
            upload_photo for photos, record_video or upload_video for videos,
            record_voice or upload_voice for voice notes, upload_document for
            general files, choose_sticker for stickers, find_location for
            location data, record_video_note or upload_video_note for video
            notes.
        :param http_timeout: (float)
    ...
    async def get_file(
        self, file_id: str, http_timeout: Optional[float] = None
    ) -> File:
        """
        ...
        """
        return await self(GetFile(file_id=file_id), http_timeout=http_timeout)
    ...
    async def ban_chat_member(
        ...
        :param chat_id: Unique identifier for the target group or username
            of the target supergroup or channel (in the format
            @channelusername)
        :param user_id: Unique identifier of the target user
        ...
        :param revoke_messages: Pass True to delete all messages from the
            chat for the user that is being removed. If False, the user will
            be able to see messages in the group that were sent before the
    ...
    async def restrict_chat_member(
        ...
        :param permissions: A JSON-serialized object for new user
            permissions
        :param until_date: Date when restrictions will be lifted for the
            user, unix time. If user is restricted for more than 366 days or
            less than 30 seconds from the current time, they are considered
    ...
    async def promote_chat_member(
        ...
        :param chat_id: Unique identifier for the target chat or username
            of the target channel (in the format @channelusername)
        :param user_id: Unique identifier of the target user
        :param is_anonymous: Pass True, if the administrator's presence in
            the chat is hidden
        :param can_manage_chat: Pass True, if the administrator can access
            the chat event log, chat statistics, message statistics in
        ...
        :param can_delete_messages: Pass True, if the administrator can
            delete messages of other users
        :param can_manage_video_chats: Pass True, if the administrator can
            manage video chats
        :param can_restrict_members: Pass True, if the administrator can
            restrict, ban or unban chat members
        :param can_promote_members: Pass True, if the administrator can
            add new administrators with a subset of their own privileges or
            demote administrators that he has promoted, directly or
            indirectly (promoted by administrators that were appointed by
            him)
        :param can_change_info: Pass True, if the administrator can change
    ...
    async def export_chat_invite_link(
        self, chat_id: Union[int, str], http_timeout: Optional[float] = None
    ) -> str:
        """
        ...
        """
        return await self(
            ExportChatInviteLink(chat_id=chat_id), http_timeout=http_timeout
        )
    ...
    async def create_chat_invite_link(
        ...
        :param expire_date: Point in time (Unix timestamp) when the link
            will expire
        :param member_limit: The maximum number of users that can be
            members of the chat simultaneously after joining the chat via
            this invite link; 1-99999
        :param creates_join_request: True, if users joining the chat via
            the link need to be approved by chat administrators. If True,
    ...
    async def revoke_chat_invite_link(
        ...
        :param chat_id: Unique identifier of the target chat or username
            of the target channel (in the format @channelusername)
    ...
    async def set_chat_photo(
        ...
        """
        return await self(
            SetChatPhoto(chat_id=chat_id, photo=photo),
            http_timeout=http_timeout,
        )
    ...
    async def delete_chat_photo(
        ...
        """
        return await self(
            DeleteChatPhoto(chat_id=chat_id), http_timeout=http_timeout
        )
    ...
    async def set_chat_title(
        ...
        """
        return await self(
            SetChatTitle(chat_id=chat_id, title=title),
            http_timeout=http_timeout,
        )
    ...
    async def pin_chat_message(
        ...
        :param disable_notification: Pass True, if it is not necessary to
            send a notification to all chat members about the new pinned
    ...
    async def unpin_chat_message(
        ...
        :param message_id: Identifier of a message to unpin. If not
            specified, the most recent pinned message (by sending date) will
            be unpinned.
        :param http_timeout: (float)
    ...
    async def unpin_all_chat_messages(
        ...
        """
        return await self(
            UnpinAllChatMessages(chat_id=chat_id), http_timeout=http_timeout
        )
    ...
    async def leave_chat(
        ...
        """
        return await self(
            LeaveChat(chat_id=chat_id), http_timeout=http_timeout
        )
    ...
    async def get_chat(
        ...
        """
        return await self(GetChat(chat_id=chat_id), http_timeout=http_timeout)
    ...
    async def get_chat_administrators(
        ...
        """
        return await self(
            GetChatAdministrators(chat_id=chat_id), http_timeout=http_timeout
        )
    ...
    async def get_chat_member_count(
        ...
        """
        return await self(
            GetChatMemberCount(chat_id=chat_id), http_timeout=http_timeout
        )
    ...
    async def delete_chat_sticker_set(
        ...
        """
        return await self(
            DeleteChatStickerSet(chat_id=chat_id), http_timeout=http_timeout
        )
    ...
    async def answer_callback_query(
        ...
        :param callback_query_id: Unique identifier for the query to be
            answered
        :param text: Text of the notification. If not specified, nothing
        ...
        :param show_alert: If True, an alert will be shown by the client
            ...
            to false.
        :param url: URL that will be opened by the user's client. If you
            have created a Game and accepted the conditions via @BotFather,
        ...
        :param cache_time: The maximum amount of time in seconds that the
            ...
            apps will support caching starting in version 3.14. Defaults to
            0.
        :param http_timeout: (float)
    ...
    async def set_my_commands(
        ...
        :param commands: A JSON-serialized list of bot commands to be set
            as the list of the bot's commands. At most 100 commands can be
            specified.
        :param scope: A JSON-serialized object, describing scope of users
            for which the commands are relevant. Defaults to
    ...
    async def set_chat_menu_button(
        ...
        :param chat_id: Unique identifier for the target private chat. If
            not specified, default bot's menu button will be changed
        :param menu_button: A JSON-serialized object for the bot's new
    ...
    async def get_chat_menu_button(
        ...
        """
        return await self(
            GetChatMenuButton(chat_id=chat_id), http_timeout=http_timeout
        )
    ...
    async def set_my_default_administrator_rights(
        ...
        :param rights: A JSON-serialized object describing new default
            administrator rights. If not specified, the default administrator
            rights will be cleared.
        :param for_channels: Pass True to change the default administrator
            rights of the bot in channels. Otherwise, the default
    ...
    async def get_my_default_administrator_rights(
        ...
        :param for_channels: Pass True to get default administrator rights
            of the bot in channels. Otherwise, default administrator rights
    ...
    async def edit_message_text(
        ...
        :param text: New text of the message, 1-4096 characters after
            entities parsing
        :param chat_id: Required if inline_message_id is not specified.
            Unique identifier for the target chat or username of the target
            channel (in the format @channelusername)
        ...
        :param disable_web_page_preview: Disables link previews for links
            in this message
        :param reply_markup: A JSON-serialized object for an inline
            keyboard.
        :param http_timeout: (float)
    ...
    async def edit_message_media(
        ...
        :param media: A JSON-serialized object for a new media content of
            the message
        :param chat_id: Required if inline_message_id is not specified.
            Unique identifier for the target chat or username of the target
            channel (in the format @channelusername)
    ...
    async def stop_poll(
        ...
        :param chat_id: Unique identifier for the target chat or username
            of the target channel (in the format @channelusername)
        :param message_id: Identifier of the original message with the
            poll
        :param reply_markup: A JSON-serialized object for a new message
            inline keyboard.
        :param http_timeout: (float)
    ...
    async def send_sticker(
        ...
        :param chat_id: Unique identifier for the target chat or username
            of the target channel (in the format @channelusername)
        :param sticker: Sticker to send. Pass a file_id as String to send
            a file that exists on the Telegram servers (recommended), pass an
    ...
    async def get_sticker_set(
        self, name: str, http_timeout: Optional[float] = None
    ) -> StickerSet:
        """
        ...
        """
        return await self(GetStickerSet(name=name), http_timeout=http_timeout)
    ...
    async def upload_sticker_file(
        ...
        :param png_sticker: PNG image with the sticker, must be up to 512
            ...
            width or height must be exactly 512px. More information on
            Sending Files »
        :param http_timeout: (float)
        ...
        """
        return await self(
            UploadStickerFile(user_id=user_id, png_sticker=png_sticker),
            http_timeout=http_timeout,
        )
    ...
    async def create_new_sticker_set(
        ...
        :param png_sticker: PNG image with the sticker, must be up to 512
            ...
            to send a file that already exists on the Telegram servers, pass
        ...
        :param webm_sticker: WEBM video with the sticker, uploaded using
            multipart/form-data. See
            https://core.telegram.org/stickers#video-sticker-requirements for
            technical requirements
        :param contains_masks: Pass True, if a set of mask stickers should
            be created
        :param mask_position: A JSON-serialized object for position where
    ...
    async def set_sticker_position_in_set(
        self, sticker: str, position: int, http_timeout: Optional[float] = None
    ) -> bool:
        """
    ...
    async def delete_sticker_from_set(
        self, sticker: str, http_timeout: Optional[float] = None
    ) -> bool:
        """
        ...
        """
        return await self(
            DeleteStickerFromSet(sticker=sticker), http_timeout=http_timeout
        )
    ...
    async def set_sticker_set_thumb(
        ...
        :param thumb: A PNG image with the thumbnail, must be up to 128
            ...
            https://core.telegram.org/stickers#animated-sticker-requirements
            for animated sticker technical requirements, or a WEBM video with
            the thumbnail up to 32 kilobytes in size; see
            https://core.telegram.org/stickers#video-sticker-requirements for
            video sticker technical requirements. Pass a file_id as a String
            to send a file that already exists on the Telegram servers, pass
            an HTTP URL as a String for Telegram to get a file from the
            Internet, or upload a new one using multipart/form-data. More
            information on Sending Files ». Animated sticker set thumbnails
        ...
        """
        return await self(
            SetStickerSetThumb(name=name, user_id=user_id, thumb=thumb),
            http_timeout=http_timeout,
        )
    ...
    async def answer_inline_query(
        ...
        :param results: A JSON-serialized array of results for the inline
            query
        :param cache_time: The maximum amount of time in seconds that the
        ...
        :param is_personal: Pass True, if results may be cached on the
            server side only for the user that sent the query. By default,
            results may be returned to any user who sends the same query
        :param next_offset: Pass the offset that a client should send in
            the next query with the same text to receive more results. Pass
            an empty string if there are no more results or if you don't
            support pagination. Offset length can't exceed 64 bytes.
        :param switch_pm_text: If passed, clients will display a button
            with specified text that switches the user to a private chat with
        ...
        :param switch_pm_parameter: Deep-linking parameter for the /start
            ...
            characters, only A-Z, a-z, 0-9, _ and - are allowed.Example: An
            inline bot that sends YouTube videos can ask the user to connect
            ...
            The user presses the button, switches to a private chat with the
            bot and, in doing so, passes a start parameter that instructs the
            bot to return an OAuth link. Once done, the bot can offer a
            switch_inline button so that the user can easily return to the
    ...
    async def answer_web_app_query(
        ...
        :param web_app_query_id: Unique identifier for the query to be
            answered
        :param result: A JSON-serialized object describing the message to
            be sent
        :param http_timeout: (float)
    ...
    async def send_invoice(
        ...
        :param payload: Bot-defined invoice payload, 1-128 bytes. This
            will not be displayed to the user, use for your internal
            processes.
        :param provider_token: Payment provider token, obtained via
            @BotFather
        :param currency: Three-letter ISO 4217 currency code, see more on
            currencies
        :param prices: Price breakdown, a JSON-serialized list of
            components (e.g. product price, tax, discount, delivery cost,
            delivery tax, bonus, etc.)
        :param max_tip_amount: The maximum accepted amount for tips in the
            smallest units of the currency (integer, not float/double). For
            example, for a maximum tip of US$ 1.45 pass max_tip_amount = 145.
        ...
        :param suggested_tip_amounts: A JSON-serialized array of suggested
            amounts of tips in the smallest units of the currency (integer,
            not float/double). At most 4 suggested tip amounts can be
            specified. The suggested tip amounts must be positive, passed in
        ...
        :param start_parameter: Unique deep-linking parameter. If left
            ...
            forwarded copies of the sent message will have a URL button with
            a deep link to the bot (instead of a Pay button), with the value
            used as the start parameter
        :param provider_data: JSON-serialized data about the invoice,
            ...
            provider.
        :param photo_url: URL of the product photo for the invoice. Can be
            a photo of the goods or a marketing image for a service. People
            like it better when they see what they are paying for.
        :param photo_size: Photo size in bytes
        :param photo_width: Photo width
        :param photo_height: Photo height
        :param need_name: Pass True, if you require the user's full name
            to complete the order
        :param need_phone_number: Pass True, if you require the user's
            phone number to complete the order
        :param need_email: Pass True, if you require the user's email
            address to complete the order
        :param need_shipping_address: Pass True, if you require the user's
            shipping address to complete the order
        :param send_phone_number_to_provider: Pass True, if the user's
            phone number should be sent to provider
        :param send_email_to_provider: Pass True, if the user's email
        ...
        :param allow_sending_without_reply: Pass True, if the message
            ...
            found
        :param reply_markup: A JSON-serialized object for an inline
            keyboard. If empty, one 'Pay total price' button will be shown.
    ...
    async def create_invoice_link(
        ...
        :param need_shipping_address: Pass True, if you require the user's
            shipping address to complete the order
        :param send_phone_number_to_provider: Pass True, if the user's
            phone number should be sent to the provider
        :param send_email_to_provider: Pass True, if the user's email
    ...
    async def answer_shipping_query(
        ...
        :param shipping_options: Required if ok is True. A JSON-serialized
            array of available shipping options.
        :param error_message: Required if ok is False. Error message in
            human readable form that explains why it is impossible to
            complete the order (e.g. "Sorry, delivery to your desired address
    ...
    async def answer_pre_checkout_query(
        ...
        :param pre_checkout_query_id: Unique identifier for the query to
            be answered
        ...
        :param error_message: Required if ok is False. Error message in
            human readable form that explains the reason for failure to
            proceed with the checkout (e.g. "Sorry, somebody just bought the
            last of our amazing black T-shirts while you were busy filling
            out your payment details. Please choose a different color or
    ...
    async def set_passport_data_errors(
        ...
        """
        return await self(
            SetPassportDataErrors(user_id=user_id, errors=errors),
            http_timeout=http_timeout,
        )
    ...
    async def send_game(
        ...
        :param game_short_name: Short name of the game, serves as the
    ...
    async def set_game_score(
        ...
        :param disable_edit_message: Pass True, if the game message should
