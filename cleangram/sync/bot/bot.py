...
class Bot(BaseBot):
    ...
    def __call__(
        ...
        return self.config.http(self, path, http_timeout)
    ...
    def get_webhook_info(
        ...
        """
        return self(GetWebhookInfo(), http_timeout=http_timeout)

    # Available methods

    def get_me(self, http_timeout: Optional[float] = None) -> User:
        """
        ...
        """
        return self(GetMe(), http_timeout=http_timeout)

    def log_out(self, http_timeout: Optional[float] = None) -> bool:
        """
        ...
        """
        return self(LogOut(), http_timeout=http_timeout)

    def close(self, http_timeout: Optional[float] = None) -> bool:
        """
        ...
        """
        return self(Close(), http_timeout=http_timeout)
    ...
    def get_file(
        ...
        """
        return self(GetFile(file_id=file_id), http_timeout=http_timeout)
    ...
    def leave_chat(
        ...
        """
        return self(LeaveChat(chat_id=chat_id), http_timeout=http_timeout)
    ...
    def get_chat(
        ...
        """
        return self(GetChat(chat_id=chat_id), http_timeout=http_timeout)
    ...
    def get_sticker_set(
        ...
        """
        return self(GetStickerSet(name=name), http_timeout=http_timeout)
