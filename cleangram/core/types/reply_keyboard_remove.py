...
class ReplyKeyboardRemove(TelegramType):
    ...
    will remove the current custom keyboard and display the
    ...
    of the original message.Example: A user votes in a poll, bot
    returns confirmation message in reply to the vote and
