...
class MaskPosition(TelegramType):
    """
    This object describes the position on faces where a mask
    ...
    face size, from left to right. For example, choosing -1.0
    will place mask just to the left of the default mask
    position."""
